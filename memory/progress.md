...
- [x] **USB file transfer (new Home module)** — full SDD on `cursor/usb-file-transfer-c861` (wireframe/spec/architecture approved 2026-09-26; tests + MTP/ADB/AFC `list_file_paths` + production UI/API). Awaiting real-device verification.
