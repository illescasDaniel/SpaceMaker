...
- [ ] **USB file transfer (new Home module)** — Phase 0 wireframe on `cursor/usb-file-transfer-c861`; awaiting design approval. MTP / ADB / iPhone USB (AFC); no convert; Documents destination. Spec/ports/impl not started.
