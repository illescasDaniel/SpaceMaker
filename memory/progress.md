...
- [ ] **USB file transfer (new Home module)** — wireframe + spec approved 2026-09-26; Phase 2 domain/ports/use case on `cursor/usb-file-transfer-c861`; awaiting **architecture approval**. Tests + adapter listing + web UI not started.
